            ...
            <div class="card">
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="font-size-16 mb-1">Edit Surat Masuk</h5>
                ...
                <div id="addproduct-productinfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                    <div class="p-4 border-top">
                        <form action="{{ route('admin.suratmasuk.update', $suratmasuk->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input id="no_surat" name="no_surat" placeholder="Masukan no_surat" type="text"
                                    value="{{ old('suratmasuk', $suratmasuk->no_surat) }}"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="tanggal_penerimaan" name="tanggal_penerimaan"
                                            value="{{ old('suratmasuk', $suratmasuk->tanggal_penerimaan) }}"
                                            placeholder="Masukan Tanggal Penerimaan Surat" type="text"
                                            class="form-control flatpickr-input @error('tanggal_penerimaan') is-invalid @enderror">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="no_agenda" name="no_agenda" placeholder="Masukan no_agenda"
                                            value="{{ old('suratmasuk', $suratmasuk->no_agenda) }}" type="text"
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        value="{{ old('suratmasuk', $suratmasuk->tanggal_surat) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="asal_surat" name="asal_surat" placeholder="Masukan Pengirim Surat"
                                            type="text" value="{{ old('suratmasuk', $suratmasuk->asal_surat) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="tujuan_surat" name="tujuan_surat"
                                            placeholder="Masukan Penerima Surat" type="text" value="{{ old('suratmasuk', $suratmasuk->tujuan_surat) }}"
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control @error('perihal') is-invalid @enderror" name="perihal"
                                    id="perihal" placeholder="Enter Perihal" rows="4">{{ old('suratmasuk', $suratmasuk->perihal) }}</textarea>
                            ...
                            <div class="row mb-4 mt-4">
                                <div class="col text-end me-4">
                                    <a href="{{ route('admin.suratmasuk.index') }}" class="btn btn-danger"> <i
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap table-centered mb-0">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($suratMasukDetail as $item => $row)
                                    <tr>
                                        <td class="text-center">{{$item + 1}}</td>
                                        <td class="text-center">{{$row->nama_file}}</td>
                                        <td class="text-center">
                                            <a href="{{ route('admin.suratMasukDetail.download', ['userid' => auth()->user()->id, 'filename' => $row->nama_file ]) }}"
                                                class="btn btn-primary w-sm"><i
                                                    class="bx bx-download me-2"></i>Download</a>
                                            <a href="{{ route('admin.suratMasukDetail.previewPdf', ['userid' => auth()->user()->id, 'filename' => $row->nama_file ]) }}"
                                                class="btn btn-dark w-sm"><i
                                                    class="bx bxs-file-pdf me-2"></i>Preview</a>
                                            <a href="{{ route('admin.suratMasukDetail.destroy', ['id' => $row->id, 'userid' => auth()->user()->id ]) }}"
                    ...
                    <div class="p-4 border-top">
                        <div>
                            <form action="#" class="dropzone" method="POST" id="my-dropzone"
                                ...
                                <input id="surat_masuk_id" name="surat_masuk_id" type="hidden"
                                    value="{{ $suratmasuk->id }}" class="form-control">
...
<script>
  ...
  var myDropzone = new Dropzone("#my-dropzone", {
    url: "{{ route('admin.suratMasukDetail.upload') }}",
