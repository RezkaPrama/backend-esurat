            ...
            <div class="card">
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="font-size-16 mb-1">Tambah Surat Masuk</h5>
                ...
                <div id="addproduct-productinfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                    <div class="p-4 border-top">
                        <form action="{{ route('admin.suratmasuk.store') }}" method="POST"
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="no_agenda" name="no_agenda" placeholder="Masukan no_agenda"
                                            type="text" class="form-control @error('no_agenda') is-invalid @enderror">
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control @error('perihal') is-invalid @enderror" name="perihal" id="perihal"
                                    placeholder="Enter Perihal" rows="4"></textarea>
...
<div class="row mb-4">
    <div class="col text-end">
        <a href="{{ route('admin.suratmasuk.index') }}" class="btn btn-danger"> <i class="bx bx-x me-1"></i> Batal </a>
